...
public class DataDriven {
    public static ArrayList<String> prepararData(String nombreCP) {
        ...
        try {
            file = new FileInputStream(utils.PropertiesManager.obtenerProperty("rutaExcel"));
        ...
        for (int i=0; i<sheets;i++){
            if(excel.getSheetName(i).equalsIgnoreCase(utils.PropertiesManager.obtenerProperty("hojaExcel"))){
                //encontre la hoja
                ...
                while(celda.hasNext()){
                    ...
                    if(celdaSeleccionada.getStringCellValue().equalsIgnoreCase(utils.PropertiesManager.obtenerProperty("TituloCasosPrueba"))){
